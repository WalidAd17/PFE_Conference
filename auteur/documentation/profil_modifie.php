...
if(isset($_POST['sub'])){
	...
	$sqll = "UPDATE auteur SET nom_a='$nom' , prenom_a='$prenom' , profession_a='$profession' , desc_a='$description' , email_a='$email' , tel_a='$tel' , adresse_a='$adresse' , nom_util_a='$username' , mdp_a='$mdp' WHERE  id_a='$id'";
