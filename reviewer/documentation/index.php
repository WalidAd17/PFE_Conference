				...
				<div class="container-fluid">
					...
					<?php
						...
						<div class="card-body">
							...
							<h5 class="mb-0 position-relative" style="color:red;"><img src="image_pfe/star.png" style="padding-bottom:5px;">&nbsp;&nbsp;Vous êtes parmi la comité du programme de la conférence en cours</h5>
							<hr><hr>
							<?php 
							$today = date("Y-m-d");
							$sql = "SELECT * FROM conference WHERE date_conference>'$today'";
							...
							<div class="row">
								...
								?>
									...
									<div class="card-body">
										<h5 class="card-title mb-2 fw-mediumbold">Nombre de papier affectés : &nbsp;<b style="color:red;"><?php echo $m." papiers";?></b></h5>
										<a href="evaluer_pap.php"><h5 class="btn btn-primary">Voir en détails</h5></a>
