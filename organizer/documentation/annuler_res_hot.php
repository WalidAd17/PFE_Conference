...
<head>
	...
	<title>Annuler réservation d'hôtel</title>
			...
			<div class="content content-documentation">
				<div class="container-fluid">
					...
					<?php
						...
						<div class="card-body">
                            <h5 class="text-center">Annuler réservation d'hôtel</h5>
                            <hr>
                            <?php 
							$today = date("Y-m-d");
							$sql = "SELECT * FROM conference WHERE date_conference>'$today'";
                            ...
                            <div class="row">
								<div class="card col-md-12" style="width: 18rem;">
									...
									<div class="card-body">
                                        <form class="row g-3 needs-validation" method="post" action="annuler_res_hot.php">
                                            <div class="col-md-12">
													<div class="form-group form-group-default">
														<label>Sélectionnez...</label>
														<select class="form-control" name="hot" id="formGroupDefaultSelect">
															<?php while ($w=mysqli_fetch_array($r)) { ?>
															<option value="<?php echo $w['id_h'] ?>">
																<?php
																echo $w['nom_h']." à ".$w['adresse_h'];
																?>
															</option>
															<?php } ?>
														</select>
...
if (isset($_POST['sub'])) {
    ...
    $sqll = "DELETE FROM hotel WHERE id_h ='$hot' ";
