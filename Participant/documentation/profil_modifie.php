...
<head>
	...
	<title>Profil participant</title>
                                    ...
                                    <form class="row g-3 needs-validation" method="post" action="profil_modifie.php">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="nom" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['nom_a'];?>" required="" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="prenom" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['prenom_a'];?>" required="" />
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="email" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['email_a'];?>" required="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="profession" aria-label="With textarea" value="<?php echo $_SESSION['profession_a'];?>" required=""></input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="description" aria-label="With textarea" value="<?php echo $_SESSION['desc_a'];?>" required=""></input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default input-solid">
                                                ...
                                                <input id="Name" name="tel" type="text" class="form-control" value="<?php echo $_SESSION['tel_a'];?>" required="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default input-solid">
                                                <label>Adresse</label>
                                                <input id="Name" name="adresse" type="text" class="form-control" value="<?php echo $_SESSION['adresse_a'];?>" required="" />
                                            </div>
                                        </div>
...
if(isset($_POST['sub'])){
	...
	$sqll = "UPDATE utilisateur SET nom_u='$nom' , prenom_u='$prenom' , profession_u='$profession' , desc_u='$description' , email_u='$email' , tel_u='$tel' , adresse_u='$adresse' , nom_util_u='$username' , mdp_u='$mdp' WHERE  id_u='$id'";
