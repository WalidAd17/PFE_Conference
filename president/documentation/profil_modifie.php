...
<head>
	...
	<title>Profil président des comités</title>
                                    ...
                                    <form class="row g-3 needs-validation" method="post" action="profil_modifie.php">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="nom" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['nomM'];?>" required="" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="prenom" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['prenomM'];?>" required="" />
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="email" class="form-control input-solid" id="solidInput" value="<?php echo $_SESSION['emailM'];?>" required="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="profession" aria-label="With textarea" value="<?php echo $_SESSION['professionM'];?>" required=""></input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="description" aria-label="With textarea" value="<?php echo $_SESSION['descriptionM'];?>" required=""></input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default input-solid">
                                                ...
                                                <input id="Name" name="tel" type="text" class="form-control" value="<?php echo $_SESSION['telM'];?>" required="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-default input-solid">
                                                <label>Adresse</label>
                                                <input id="Name" name="adresse" type="text" class="form-control" value="<?php echo $_SESSION['adresseM'];?>" required="" />
                                            </div>
                                        </div>
...
if(isset($_POST['sub'])){
	...
	$sqll = "UPDATE membre SET nomM='$nom' , prenomM='$prenom' , professionM='$profession' , descriptionM='$description' , emailM='$email' , telM='$tel' , adresseM='$adresse' , usernameM='$username' , mdpM='$mdp' WHERE  idM='$id'";
