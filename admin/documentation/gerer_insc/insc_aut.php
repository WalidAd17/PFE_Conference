...
<head>
	...
	<title>Inscription des auteurs</title>
			...
			<div class="content content-documentation">
				<div class="container-fluid">
					...
					<?php include 'main.php';
                        ?>
						<div class="card-body">
                            <h5 style="text-align:center;">Les auteurs inscrit à la conférence actuelle</h5>
							<hr>
                            <?php
								$s = "SELECT * FROM inscription_auteur";
								...
								if ($n == 0) {
									?>
									<h3>Aucun auteur n'est inscrit</h3>
									<?php
								}else{?>
									<h6><b>Les auteurs inscits: </b>&nbsp;&nbsp;&nbsp;<?php echo '<b style="color:red";>'.$n." auteurs inscrits".'</b>'?></h6>
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">nom</th>
                                                <th scope="col">Prénom</th>
                                                <th scope="col">Titre papier</th>
                            ...
                            ?>
                                    <?php while( $w= mysqli_fetch_array($r)){
                                        $ss = "SELECT * FROM auteur";
                                        $rr = mysqli_query($conn,$ss);

                                        $sss = "SELECT * FROM soumission";
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" novalidate="" method="post" action="gerer_auteur.php">
                                ...
                                <button style="margin-left:470px" class="btn btn-outline-danger me-1 mb-1" type="submit" type="button" name="sub">
                                    <span class="fas fa-plus-circle me-1" data-fa-transform="shrink-3"></span>Bloquer
                                </button>
