...
<?php 
    ...
    header("Content-Disposition: attachment; charset=UTF-8; filename=comite_organisation_du_conf_id°_:".$id."_le_".$dateconf.".xls");

    echo'<div align="center"><h3>  &nbsp;&nbsp;La comite d\'organisation</h3></div>';
